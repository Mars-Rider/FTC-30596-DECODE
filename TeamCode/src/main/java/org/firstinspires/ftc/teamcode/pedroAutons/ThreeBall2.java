...
@Autonomous(name = "3 Ball In Score Zone", group = "Autons")
public class ThreeBall2 extends OpMode {
    ...
    public void init() {
        ...
        scorePose = new Pose(robot.changeAlliance(50), 124, Globals.alliance == 1 ? Math.toRadians(0) : Math.toRadians(-180)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
        pickup1Pose = new Pose(robot.changeAlliance(50), 60, Globals.alliance == 1 ? Math.toRadians(-180) : Math.toRadians(0));
