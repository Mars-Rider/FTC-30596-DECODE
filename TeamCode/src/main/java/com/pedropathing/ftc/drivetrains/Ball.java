...
public class Ball extends Drivetrain {
     ...
     * @param ballConstants this is the MecanumConstants object that contains the names of the motors and directions etc.
     */
    public Ball(HardwareMap hardwareMap, BallConstants ballConstants) {
        constants = ballConstants;

        this.maxPowerScaling = ballConstants.maxPower;
        this.motorCachingThreshold = ballConstants.motorCachingThreshold;
        this.useBrakeModeInTeleOp = ballConstants.useBrakeModeInTeleOp;
